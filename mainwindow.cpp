...
std::string MainWindow::getGamePiece(int playerNum){
...
std::string MainWindow::spaceType(int inputIndex){
...
std::string MainWindow::getPlayerName(int playerNum){
...
std::string MainWindow::getSpaceName(int spaceIndex, int index){
