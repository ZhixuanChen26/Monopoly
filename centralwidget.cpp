...
CentralWidget::CentralWidget(int tempNum, Player* tempPlayers): QWidget() {
    ...
    boardLabel->setPixmap( QPixmap("://Images/Monopoly.png") );
    this->setGeometry(0, 0, 650, 650);

    //setting up the dice images
    dice1 = new QLabel(this);
    dice1->setPixmap(QPixmap(":/Images/dice1.png"));
    dice1->setGeometry(300, 500, 35, 35);
    ...
    dice2->setPixmap(QPixmap(":/Images/dice1.png"));
    dice2->setGeometry(350, 500, 35, 35);
    ...
    //Create the covers for the card deckx
    QTransform rm;
    QTransform rs;
    rm.rotate(-20);
    rs.rotate(-8);
  ...
  //  communityCover->setFixedWidth(180);
    ...
    for(int i = 0; i < numPlayers; i++){
        ...
        std::string tempName = tempPlayers[i].getGamePieceName();
...
void CentralWidget::changeDiceImg(int rollNum1, int rollNum2){
    ...
    if(rollNum1 == 1) {
        ...
        dice1->setPixmap(QPixmap(":/Images/dice2.png"));
    } else if (rollNum1 == 3) {
        dice1->setPixmap(QPixmap(":/Images/dice3.png"));
    } else if (rollNum1 == 4) {
        dice1->setPixmap(QPixmap(":/Images/dice4.png"));
    } else if (rollNum1 == 5) {
        dice1->setPixmap(QPixmap(":/Images/dice5.png"));
    } else if (rollNum1 == 6) {
        dice1->setPixmap(QPixmap(":/Images/dice6.png"));
    }

    if(rollNum2 == 1) {
        dice2->setPixmap(QPixmap(":/Images/dice1.png"));
    } else if (rollNum2 == 2) {
        dice2->setPixmap(QPixmap(":/Images/dice2.png"));
    } else if (rollNum2 == 3) {
        dice2->setPixmap(QPixmap(":/Images/dice3.png"));
    } else if (rollNum2 == 4) {
        dice2->setPixmap(QPixmap(":/Images/dice4.png"));
    } else if (rollNum2 == 5) {
        dice2->setPixmap(QPixmap(":/Images/dice5.png"));
    } else if (rollNum2 == 6) {
        dice2->setPixmap(QPixmap(":/Images/dice6.png"));
    }
...
void CentralWidget::initializingCards(int tempArray[]){
    ...
    chanceCards[tempArray[0]]->setPixmap(QPixmap(":/Images/chance0.png"));
    chanceCards[tempArray[0]]->setGeometry(175, 175, 180, 100);
    ...
    chanceCards[tempArray[1]]->setPixmap(QPixmap(":/Images/chance1.png"));
    chanceCards[tempArray[1]]->setGeometry(175, 175, 180, 100);
    ...
    chanceCards[tempArray[2]]->setPixmap(QPixmap(":/Images/chance2.png"));
    chanceCards[tempArray[2]]->setGeometry(175, 175, 180, 100);
    ...
    chanceCards[tempArray[3]]->setPixmap(QPixmap(":/Images/chance3.png"));
    ...
    chanceCards[tempArray[4]]->setPixmap(QPixmap(":/Images/chance4.png"));
    ...
    chanceCards[tempArray[5]]->setPixmap(QPixmap(":/Images/chance5.png"));
    ...
    chanceCards[tempArray[6]]->setPixmap(QPixmap(":/Images/chance6.png"));
    ...
    chanceCards[tempArray[7]]->setPixmap(QPixmap(":/Images/chance7.png"));
    ...
    chanceCards[tempArray[8]]->setPixmap(QPixmap(":/Images/chance8.png"));
    ...
    chanceCards[tempArray[9]]->setPixmap(QPixmap(":/Images/chance9.png"));
    ...
    communityCards[tempArray[0]]->setPixmap(QPixmap(":/Images/community0.png"));
    ...
    communityCards[tempArray[1]]->setPixmap(QPixmap(":/Images/community1.png"));
    ...
    communityCards[tempArray[2]]->setPixmap(QPixmap(":/Images/community2.png"));
    ...
    communityCards[tempArray[3]]->setPixmap(QPixmap(":/Images/community3.png"));
    ...
    communityCards[tempArray[4]]->setPixmap(QPixmap(":/Images/community4.png"));
    ...
    communityCards[tempArray[5]]->setPixmap(QPixmap(":/Images/community5.png"));
    ...
    communityCards[tempArray[6]]->setPixmap(QPixmap(":/Images/community6.png"));
    ...
    communityCards[tempArray[7]]->setPixmap(QPixmap(":/Image/community7.png"));
    ...
    communityCards[tempArray[8]]->setPixmap(QPixmap(":/Images/community8.png"));
    ...
    communityCards[tempArray[9]]->setPixmap(QPixmap(":/Images/community9.png"));
