...
BottomBar::BottomBar() {
    ...
    //Community Card 0
    community[index[0]]->setCardText(":/Images/community0.png");
    community[index[0]]->setAmount(0);

    //Community Card 1
    community[index[1]]->setCardText(":/Images/community1.png");
    community[index[1]]->setAmount(75);

    //Community Card 2
    community[index[2]]->setCardText(":/Images/community2.png");
    community[index[2]]->setAmount(150);

    //Community Card 3
    community[index[3]]->setCardText(":/Images/community3.png");
    community[index[3]]->setAmount(24);

    //Community Card 4
    community[index[4]]->setCardText(":/Images/community4.png");
    community[index[4]]->setAmount(100);

    //Community Card 5
    community[index[5]]->setCardText(":/Images/community5.png");
    community[index[5]]->setAmount(20);

    //Community Card 6
    community[index[6]]->setCardText(":/Images/community6.png");
    community[index[6]]->setAmount(39);

    //Community Card 7
    community[index[7]]->setCardText(":/Images/community7.png");
    community[index[7]]->setAmount(15);

    //Community Card 8
    community[index[8]]->setCardText(":/Images/community8.png");
    community[index[8]]->setAmount(200);

    //Community Card 9
    community[index[9]]->setCardText(":/Images/community9.png");
    ...
    //Chance Card 0
    chance[index[0]]->setCardText(":/Images/chance0.png");
    chance[index[0]]->setAmount(0);

    //Chance Card 1
    chance[index[1]]->setCardText(":/Images/chance1.png");
    chance[index[1]]->setAmount(28);

    //Chance Card 2
    chance[index[2]]->setCardText(":/Images/chance2.png");
    chance[index[2]]->setAmount(50);

    //Chance Card 3
    chance[index[3]]->setCardText(":/Images/chance3.png");
    chance[index[3]]->setAmount(11);

    //Chance Card 4
    chance[index[4]]->setCardText(":/Images/chance4.png");
    chance[index[4]]->setAmount(100);

    //Chance Card 5
    chance[index[5]]->setCardText(":/Images/chance5.png");
    chance[index[5]]->setAmount(15);

    //Chance Card 6
    chance[index[6]]->setCardText(":/Images/chance6.png");
    chance[index[6]]->setAmount(15);

    //Chance Card 7
    chance[index[7]]->setCardText(":/Images/chance7.png");
    chance[index[7]]->setAmount(15);

    //Chance Card 8
    chance[index[8]]->setCardText(":/Images/chance8.png");
    ...
    layout->addWidget(endTurnButton, 0, 0);
    layout->addWidget(upgradeButton, 0, 1);
    layout->addWidget(purchaseButton, 0, 2);
    layout->addWidget(rollButton, 0, 3);
    layout->addWidget(player1Button, 1, 0);
...
void BottomBar::endTurn(){
    ...
    if(numAlive <= 1){
        ...
        QString qInformative = QString::fromStdString(informativeText);

        QMessageBox winnerDisplay;
        winnerDisplay.setText(qText);
        winnerDisplay.setInformativeText(qInformative);
        winnerDisplay.exec();
    }
